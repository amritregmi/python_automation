...
class CreateTransactionCheckingCreditCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionCheckingCreditCreateAndContinue(self):
		self._caseId = 131
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123416789")
