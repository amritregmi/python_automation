...
class EmptyAccountNumberCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_EmptyAccountNumberCreateAndContinue(self):
		self._caseId = 137
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("")
