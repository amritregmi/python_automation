...
class MultipleEmailCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_MultipleEmailCreateAndContinue(self):
		self._caseId = 323
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123442389")
