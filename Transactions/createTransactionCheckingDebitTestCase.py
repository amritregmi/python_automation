...
class CreateTransactionCheckingDebitTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionCheckingDebit(self):
		self._caseId = 128
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("125446789")
