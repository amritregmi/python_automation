...
class CreateTransactionSavingsCreditCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionSavingsCreditCreateAndContinue(self):
		self._caseId = 140
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123446789")
