...
class CreateTransactionCheckingDebitCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionCheckingDebitCreateAndContinue(self):
		self._caseId = 139
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionRoutingNumber").send_keys("121000358")
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123557769")

		#clicking The button Debit Type which is automatically clicked
		driver.find_element_by_id("TransactionTypeDebit").click()
