...
class CreateTransactionsSavingsDebitCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionsSavingsDebitCreateAndContinue(self):
		self._caseId = 141
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionRoutingNumber").send_keys("063100277")
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123366789")

		#clicking button Checking Type
		driver.find_element_by_id("TransactionBankAccountTypeS").click()

		#clicking The button Debit Type
