...
class InvalidEmailCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_InvalidEmailCreateAndContinue(self):
		self._caseId = 322
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionEmails").send_keys("amsdsd")
