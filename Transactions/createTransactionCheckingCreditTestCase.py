...
class CreateTransactionCheckingCreditTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionCheckingCredit(self):
		self._caseId = 120
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionRoutingNumber").send_keys("324377516")
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("223456777")
