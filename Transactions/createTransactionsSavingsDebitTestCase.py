...
class CreateTransactionsSavingsDebitTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_CreateTransactionsSavingsDebit(self):
		self._caseId = 130
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionRoutingNumber").send_keys("051000017")
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("120056789")
		...
		#check if its in transactions link
