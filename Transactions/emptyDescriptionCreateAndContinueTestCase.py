...
class EmptyDescriptionAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_EmptyDescriptionAndContinue(self):
		self._caseId = 135
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionDescription").send_keys("")
