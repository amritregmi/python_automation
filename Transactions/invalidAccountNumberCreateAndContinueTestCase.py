...
class InvalidAccountNumberCreateAndContinueTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_InvalidAccountNumberCreateAndContinue(self):
		self._caseId = 321
		self._suiteId = 2
		self._user = "rumbu"
		...
		driver.find_element_by_id("TransactionAccountNumber").send_keys("123")
