...
class EmptyRoutingNumberFieldTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyRoutingNumberField(self):
        self._caseId = 288
        self._suiteId = 8
        self._user = "rumbu"
        ...
        driver.find_element_by_id("route_num").send_keys("")
