...
class EmptyDescriptionTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyDescription(self):
        ...
        driver.find_element_by_id("CheckoutDescription").send_keys("")

        driver.find_element_by_id("CheckoutAmount").clear()
        driver.find_element_by_id("CheckoutAmount").send_keys("123456")
