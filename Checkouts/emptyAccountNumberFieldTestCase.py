...
class EmptyAccountNumberFieldTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyAccountNumberField(self):
        self._caseId = 289
        self._suiteId = 8
        self._user = "rumbu"
        ...
        driver.find_element_by_id("acco_num").send_keys("")
