...
class InvalidRoutingNumberFieldTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_invalidRoutingNumberField(self):
        self._caseId = 312
        self._suiteId = 8
        self._user = "rumbu"
        ...
        routing_numbers = ['0000', '1234567', 'this is invalid routing numbers', '1234567890']
        for routing_number in routing_numbers:
            ...
            driver.find_element_by_id("route_num").send_keys(routing_number)
