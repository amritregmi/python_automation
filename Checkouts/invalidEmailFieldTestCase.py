...
class InvalidEmailFieldTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_invalidEmailField(self):
        self._caseId = 311
        self._suiteId = 8
        self._user = "rumbu"
        ...
        emails = ['123456', 'this is invalid email address', "#$%^^&&@####"]
        for email in emails:
            ...
            driver.find_element_by_id("emailAdd").send_keys(email)
