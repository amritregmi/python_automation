...
class createAndContinueCustomersCheckingTypeTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_createAndContinueCustomersCheckingType(self):
		self._caseId = 1450
		self._suiteId = 33
		self._user = "rumbu"
		...
		driver.find_element_by_id("CustomerAccountTypeC").click()
