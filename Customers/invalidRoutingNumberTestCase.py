...
class invalidRoutingNumberTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_RoutingNumber(self):
		self._caseId = 1445
		self._suiteId = 33
		self._user = "rumbu"
		...
		myList=['000','amr','/1233','1@?abs','12345678','1234567890']
		...
		for names in myList:
			...
			driver.find_element_by_id("CustomerRoutingNumber").send_keys(names)
