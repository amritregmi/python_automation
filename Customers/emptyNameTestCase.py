...
class emptyNameTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
	...
	def test_emptyName(self):
		...
		driver.find_element_by_id("CustomerCustomerName").send_keys("")
		...
		driver.find_element_by_id("CustomerAccountNumber").send_keys("3123213131")
