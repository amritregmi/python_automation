...
class emptyRoutingNumberTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):

	def test_emptyRoutingNumber(self):
		self._caseId = 1442
		self._suiteId = 33
		self._user = "rumbu"
		...
		driver.find_element_by_id("CustomerCustomerName").send_keys("Vericheck")
		driver.find_element_by_id("CustomerRoutingNumber").clear()
		driver.find_element_by_id("CustomerRoutingNumber").send_keys("")
		driver.find_element_by_id("CustomerAccountNumber").clear()
		driver.find_element_by_id("CustomerAccountNumber").send_keys("123456789")
