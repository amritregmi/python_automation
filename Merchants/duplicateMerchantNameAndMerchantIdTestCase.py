...
class DuplicateMerchantNameAndMerchantIdTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_duplicateMerchantNameAndMerchantId(self):
        self._caseId = 145
        self._suiteId = 3
        self._user = "Admin"
        ...
        driver.find_element_by_id("MerchantName").send_keys("latest Merchant")

        driver.find_element_by_id("MerchantBackendMerchantId").clear()
        driver.find_element_by_id("MerchantBackendMerchantId").send_keys("007")
