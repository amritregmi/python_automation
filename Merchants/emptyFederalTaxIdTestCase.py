...
class EmptyFederalTaxIdTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyFederalTaxId(self):
        self._caseId = 149
        self._suiteId = 3
        self._user = "Admin"
        ...
        driver.find_element_by_id("MerchantFederalTaxId").send_keys("")
