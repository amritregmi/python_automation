...
class EmptyMerchantNameTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyMerchantName(self):
        self._caseId = 147
        self._suiteId = 3
        self._user = "Admin"
        ...
        driver.find_element_by_id("MerchantName").send_keys("")
