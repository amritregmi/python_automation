...
class EmptyMerchantIdTestCase(loggedInBaseTestCase.LoggedInBaseTestCase):
    def test_emptyMerchantId(self):
        self._caseId = 146
        self._suiteId = 3
        self._user = "Admin"
        ...
        driver.find_element_by_id("MerchantBackendMerchantId").send_keys("")
